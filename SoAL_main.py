...
from soal_consts import IMG_QUEUE_CAPACITY, PRED_PROCESS_NUM, VIDEO_TODO_DIR, MAX_TASK
...
def soal_main():
    ...
    from soal3_predict_parts_1 import PredictParts
    pred_q_l = []
    ...
    from soal2_region_seg_1 import RegionSeg
